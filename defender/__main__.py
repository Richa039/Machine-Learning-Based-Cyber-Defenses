...
if __name__ == "__main__":
    ...
    #                              model_max_history,
    #                              model_name)
    model = joblib.load('/opt/defender/defender/models/rf_und_2.pkl')
    vect = joblib.load('/opt/defender/defender/models/vect_und_2.pkl')
    app = create_app(model, vect)
    ...
    # curl -XPOST --data-binary @c:\Users\handh\Downloads\csce689proj\1.exe http://127.0.0.1:8080/ -H "Content-Type: application/octet-stream"
